...
export const journalPosts: JournalPost[] = [
  {
    slug: 'what-a-washed-cap-actually-means',
    title: 'what a washed cap actually means',
    excerpt: 'there\'s a hat you actually wear. and there\'s the rest of them.',
    date: 'June 20, 2026',
    readTime: '3 min read',
    artClass: 'journal-art-photo',
    image: '/products/washed-dad-hat.jpg',
    imageAlt: 'stak washed dad hat in walnut, six-panel cotton cap',
    pageTitle: 'What a Washed Cap Actually Means — Field Notes | STAK',
    body: [
      'there\'s a hat you actually wear. and there\'s the rest of them.',
      'the one you wear is soft. the brim has a curve you didn\'t put there on purpose. it sits low and easy and you stopped noticing it a long time ago. that\'s the one.',
      'the rest sit in a drawer. too stiff, too tall, too new. you bought them meaning to break them in and never did.',
      'when we made the hat for drop 001, we wanted to skip the drawer part.',
      '## the problem with a new cap',
      'most caps come off the line stiff. structured foam in the front panels to hold a shape. a flat brim. a crown that sits up high and announces itself.',
      'they look new because they are new. and they keep looking new, in the bad way, until you\'ve worn them enough times to soften them up. that can take months. some never get there.',
      'we didn\'t want a hat you had to break in. we wanted one that showed up already broken in.',
      'that\'s what washing does.',
      '## what "washed" actually means',
      'a lot of hats get called washed when nothing really happened to them. it\'s just a word on the tag.',
      'a real washed dad hat goes through an actual wash process after it\'s built. the finished cap gets run through water, sometimes with stones or enzymes, to break down the stiffness in the cotton. the fibers loosen. the color drops a shade. the whole thing relaxes.',
      'the result is a washed baseball cap that feels like you\'ve had it a year on the first day. the brim bends easy. the fabric has give. it sits down instead of standing up.',
      'it\'s the same idea as garment dyeing a tee, just for a cap. you finish the thing, then you put it through something that ages it on purpose.',
      '## why a dad hat',
      'we went with a six-panel unstructured cap. no foam, no high crown. low profile. the kind of shape that doesn\'t try.',
      'the dad hat takes jokes but it earned its spot. it\'s the most forgiving hat there is. it works on most heads, with most faces, whether you\'re walking out for coffee or you\'ve been outside all day.',
      'structured caps make you look like you\'re headed somewhere specific. a soft, low, washed cap just looks like you. that fit what we\'re building.',
      'ours is walnut. soft cotton, brass buckle, the wordmark stitched small on the front. nothing loud.',
      'it\'s the hat we reach for. that was the whole test.',
      '[the washed dad hat is live in drop 001](https://www.stakclothing.com/shop/washed-dad-hat)',
      'short run. when it\'s gone, it\'s gone.',
    ],
  },
  {
